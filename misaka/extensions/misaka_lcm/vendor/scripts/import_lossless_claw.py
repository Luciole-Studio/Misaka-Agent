...
import argparse
from contextlib import closing  # misaka: U04 SQLite connection context commits, it does not close
import hashlib
import json
import sqlite3
import sys
...
from misaka.extensions.misaka_lcm.host.config_bridge import load_config  # misaka: native host configuration


from misaka.extensions.misaka_lcm.vendor.config import LCMConfig  # noqa: E402
from misaka.extensions.misaka_lcm.vendor.dag import build_nodes_fts_spec  # noqa: E402
from misaka.extensions.misaka_lcm.vendor.db_bootstrap import ensure_external_content_fts  # noqa: E402
from misaka.extensions.misaka_lcm.vendor.ingest_protection import protect_message_for_ingest  # noqa: E402
from misaka.extensions.misaka_lcm.vendor.message_content import normalize_content_value  # noqa: E402
from misaka.extensions.misaka_lcm.vendor.store import MessageStore, _normalize_source_value  # noqa: E402
from misaka.extensions.misaka_lcm.vendor.tokens import count_message_tokens  # noqa: E402
...
def _process_import_candidates(
    *,
    ...
    protection_config = load_config(database=target_path)
