...
from .context_engine import ContextEngine, sanitize_memory_context
from .context_compressor_summary import SummaryDispatchMixin
from .error_classifier import FailoverReason, classify_api_error
from .micro_compaction import MicroCompactionMixin
...
from .support import drop_stale_api_content
from .support import TODO_INJECTION_HEADER
...
def _is_summary_access_or_quota_error(exc: Exception) -> bool:
    ...
    try:
        ...
        from .support import UnscopedSecretError
...
def _salvage_reduce_todo_snapshot(out: List[Dict[str, Any]]) -> None:
    ...
    from .support import _PRUNED_SKILL_RELOAD_NOTICE_HEADER
...
def _today_for_prompt() -> str:
    ...
    try:
        ...
        from ..host.native import now as _hermes_now
...
class ContextCompressor(SummaryDispatchMixin, MicroCompactionMixin, ContextEngine):
    ...
    def _serialize_for_summary(self, turns: List[Dict[str, Any]]) -> str:
        ...
        from .support import strip_think_blocks
        parts = []
        for msg in turns:
...
Write only the summary body. Do not include any preamble or prefix."""
    ...
    def _latest_user_task_snapshot(cls, messages: List[Dict[str, Any]]) -> Optional[str]:
        ...
        from .support import _is_real_user_message
        for msg in reversed(messages):
    ...
    def _tool_call_id_variants(tc) -> set:
        ...
        """
        from .support import tool_call_id_variants
    ...
    def _sanitize_tool_pairs(self, messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        from .support import _classify_tool_call_orphans
    ...
    def _reappend_inflight_user_task(
        ...
        replay.pop("_misaka_replay_source", None)  # misaka: restatement is a new derived row
    ...
    def _finalize_compressed(
        ...
        try:
            ...
            from ..host.native import trim_memory
