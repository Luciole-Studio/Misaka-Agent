...
from .model_metadata import estimate_messages_tokens_rough, estimate_tokens_rough

# Log name parity with the origin module.
logger = logging.getLogger(__package__ + ".context_compressor")  # misaka: same scoped logger as the compressor
...
class MicroCompactionMixin:
    ...
    def _micro_summarize_one(self, exchange_text: str) -> Optional[str]:
        ...
        from ..host.native import aux_interrupt_protection, call_llm
