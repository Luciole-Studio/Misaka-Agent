...
from misaka.extensions.hermes_lcm.vendor import trajectory_store as ts


def _voyage_pricing_table() -> dict[str, float]:
    try:
        from misaka.extensions.hermes_lcm.vendor.command import _VOYAGE_USD_PER_MILLION_TOKENS
