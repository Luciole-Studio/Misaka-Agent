"""Build safe FTS/LIKE queries, adapted from hermes-lcm search_query.py.

CJK and emoji queries use LIKE when unicode61 cannot index them. Input is NFC
normalized, boolean operators are neutralized, and helpers remain pure.
"""
