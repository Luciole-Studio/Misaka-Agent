# Hermes f03ed94a34f47ebca57e4a1b0a890bc2aeb5e140 / tools/skill_linter.py; see PROVENANCE.json and LICENSE.
...
from .metadata import SKILL_PROMPT_DESC_LIMIT, parse_frontmatter
