# Hermes f03ed94a34f47ebca57e4a1b0a890bc2aeb5e140 / tools/skills_hub_sources.py; see PROVENANCE.json and LICENSE.
...
class BrowseShSource(SkillSource):
    ...
    def _resolve_skill_md_url(self, slug: str, item: Dict) -> Optional[str]:
        ...
        from misaka.core.skills.scope import base_url_host_matches
