# Hermes f03ed94a34f47ebca57e4a1b0a890bc2aeb5e140 / tools/skills_sync_optional.py; see PROVENANCE.json and LICENSE.
...
def _content_hash(directory: Path) -> str:
    ...
    try:
        from misaka.core.skills.guard import content_hash
