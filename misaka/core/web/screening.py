...
This module composes :mod:`misaka.core.web.url_safety` (what is in the URL) and
:mod:`misaka.core.web.website_policy` (what the operator will allow). Neither
...
:mod:`misaka.core.web.bounded`, which has to make it again at every redirect hop
...
def screen_url(url: str, *, third_party: bool = False) -> Screening:
    ...
    :func:`~misaka.core.web.website_policy.check_website_access`) -- a typo in a
