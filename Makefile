...
lint:
	$(PY) -m ruff check misaka tests bench --exclude misaka/core/documents/pageindex --exclude misaka/core/lcm/vendor --exclude tests/hermes_lcm_vendor --exclude misaka/ai/models_generated.py --exclude misaka/ai/image_models_generated.py
